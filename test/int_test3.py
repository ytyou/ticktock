...
class DataPoint(object):
    ...
    def __init__(self, metric: str, timestamp, value, tags=None):
        self._metric = metric
...
class DataPoints(object):
    ...
    def __init__(self, prefix: str, start, interval_ms=5000, metric_count=2, metric_cardinality=2, tag_cardinality=2, out_of_order=False):
...
class Query(object):
    ...
    def __init__(self, metric: str, start, end=None, tags=None, aggregator=None, downsampler=None, rate_options=None):
        self._metric = metric
        self._start = start
        self._end = end
        self._tags = tags
...
class Test(object):
    ...
    def metric_name(self, idx, prefix: str = None):
        if not prefix:
            prefix = self._prefix
    ...
    def send_data_to_ticktock_udp(self, dps):
        ...
        for dp in dps.get_dps():
            ...
            self._udp_socket.sendto(bytes(dp.to_plain(), 'utf-8'), (self._options.ip, self._options.dataport))
        self._ticktock_time += time.time() - start
...
class Compaction_Tests(Test):
    ...
    def __init__(self, options, prefix: str = "compact"):
...
class Multi_Thread_Tests(Test):
    ...
    def __init__(self, options, prefix: str = "mt"):
...
class Out_Of_Order_Write_Tests(Test):
    ...
    def __init__(self, options, prefix: str = "o"):
...
class Stop_Restart_Tests(Test):
    ...
    def __init__(self, options, prefix: str = "sr"):
...
class Backfill_Tests(Test):
    ...
    def __init__(self, options, prefix: str = "bf"):
...
class Basic_Query_Tests(Test):
    ...
    def __init__(self, options, prefix: str = "bq", tcp_socket=None):
    ...
    def __call__(self, metric_count=2, metric_cardinality=2, tag_cardinality=2, run_tt=True, via_udp=False, via_tcp=False):
        ...
        if run_tt:
            ...
            config.add_entry("tsdb.compressor.version", "4");
...
class Advanced_Query_No_Fill_Tests(Test):
    ...
    def __init__(self, options, prefix: str = "aq", tcp_socket=None):
...
class Query_Tests(Test):
    ...
    def test_once(self, prefix: str, conf):
...
class Rate_Tests(Test):
    ...
    def __init__(self, options, prefix: str = "r"):
...
class Duplicate_Tests(Test):
    ...
    def __init__(self, options, prefix: str = "dup"):
...
class Replication_Tests(Test):
    ...
    def __init__(self, options, prefix: str = "rep"):
...
class Partition_Test(Test):
    ...
    def __init__(self, options, idx, prefix: str = "part"):
...
class Partition_Tests(Test):
    ...
    def __init__(self, options, prefix: str = "part"):
...
class Check_Point_Tests(Test):
    ...
    def __init__(self, options, prefix: str = "cp"):
...
class Memory_Leak_Tests(Test):
    ...
    def __init__(self, options, prefix: str = "ml"):
...
class Long_Running_Tests(Test):
    ...
    def __init__(self, options, prefix: str = "lr"):
