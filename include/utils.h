...
extern Timestamp validate_resolution(Timestamp ts, bool ms); // return timestamp with correct unit
...
extern bool starts_with_case_insensitive(const char *str, const char *prefix);
...
extern void replace_last(std::string& str, const std::string& old_sub, const std::string& new_sub);
