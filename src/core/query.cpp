...
void
DataPointContainer::collect_data(Timestamp from, struct tsdb_header *tsdb_header, struct page_info_ext *page_header, void *page)
{
    ...
    PageSize page_size = position.m_offset;
    if (position.m_start != 0) page_size++;
